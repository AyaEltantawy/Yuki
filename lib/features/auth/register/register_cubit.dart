...
import 'package:yuki/features/auth/otp/otp_view.dart';
...
class RegisterCubit extends Cubit<RegisterState> {
  ...
  Register() async {
    ...
    DioHelper.post("auth/register", false, body: body).then(await (response) {
      ...
      if (data['status'] == true) {
        ...
        showDialog(
            ...
            builder: (context) => ResetPasswordDialog(
                  mainText: 'Activation Code has been sent to your Email at ',
                  email: emailController.text,
                ));
        // );
      } else {
