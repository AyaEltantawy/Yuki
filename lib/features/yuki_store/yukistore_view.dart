        ...
        body: SafeArea(child: BlocBuilder<YukistoreCubit, YukistoreState>(
          ...
          return ListView(
              ...
              children: [
                ...
                Text(
            cubit.activeIndex ==  1?    "Yuki Store":  cubit.activeIndex ==  0?  "Flash Sale" :"",
                ...
                Text(
                  cubit.activeIndex ==  1?        "Browse Our Products": cubit.activeIndex ==  0? 'Browse Our Flash sale Products':'',
