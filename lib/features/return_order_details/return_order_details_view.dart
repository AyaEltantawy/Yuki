...
import 'package:yuki/features/order_details/widgets/custom_products_in_order_details.dart';
...
class ReturnOrderDtailsPage extends StatelessWidget {
  const ReturnOrderDtailsPage({super.key,
    this.orderStatus,
    ...
    return BlocProvider(
        ...
        BlocBuilder<ReturnOrderDetailsCubit, ReturnOrderDetailsState>(
            builder: (context, state) {
              final controller = BlocProvider.of<ReturnOrderDetailsCubit>(
                  context);
              return ListView(
  ...
  child: Row(
    children: [
      Image.asset("assets/images/return_order_image.png",width:150.w,height:120.h),
