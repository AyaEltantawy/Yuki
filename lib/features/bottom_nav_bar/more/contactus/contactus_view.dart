        ...
        body: SafeArea(
          child: BlocBuilder<ContactusCubit, ContactusState>(
            builder: (context, state) {
              final controller = BlocProvider.of<ContactusCubit>(context);
              return ListView(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: CustomButton(
                      child: Text(
                          "Send", style: TextStyles.font16White700Weight),
                    ),
                  ),
                  Row(children: [
                    ...
                    Flexible(
                      child: RichText(
                        ...
                        text: TextSpan(text: "contact numbers:\n",
                            ...
                            children: [
                              TextSpan(
                                  text:controller.contactUsResponse?.data?.numbers?[0], style: TextStyles.font15Black400Weight)
                    ...
                    Flexible(
                      child: RichText(
                        ...
                        text: TextSpan(text: "Email Address\n",
                            style: TextStyles.font15Icongrey400Weight,
                            children: [
                              TextSpan(text: controller.contactUsResponse?.data?.email,
