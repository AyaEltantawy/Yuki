...
import 'package:yuki/features/return_order_details/return_order_details_view.dart';
            ...
            builder: (context, state) {
              ...
              return ListView(
                  ...
                  children: [
                    ...
                    CustomOrder(onTap: (){MagicRouter.navigateTo(ReturnOrderDtailsPage(orderStatus:"Accepted"));},
                        statusText: "Accepted",
                        isCancel: false,
                        isReturn: true),
                    SizedBox(height: 10.h,),
                    CustomOrder(statusText: "Rejected",
                        isCancel: false,
                        isReturn: true),
                    SizedBox(height: 10.h,),
                    CustomOrder(
                    ...
                    SizedBox(height: 10.h,),
                    CustomOrder(statusText: "Accepted",
                        isCancel: false,
                        isReturn: true),
                    SizedBox(height: 10.h,),
                    CustomOrder(statusText: "Rejected",
